...
Для того, чтобы сыграть в игру, вам необходимо скачать архив с файлами игры по [ссылке](https://github.com/GenaKolobok/The_Shadow/releases/tag/v1.0), распаковать его в удобное место, и запустить файл **The Shadow.exe**:
