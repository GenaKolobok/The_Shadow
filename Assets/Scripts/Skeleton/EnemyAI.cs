...
public class EnemyAI : MonoBehaviour //основной AI врагов
{
    ...
    private NavMeshAgent _navMeshAgent; //навмеш для передвижения
    ...
    private void StateHandler() //обработка состояний
    {
        switch (_currentState)
        {
            case State.Roaming: //патрулирование
                ...
                CheckCurrentState();
                break;
            case State.Chasing: //преследование
                ChaisingTarget();
                CheckCurrentState();
                break;
